...
class MainHandler(tornado.web.RequestHandler):
    def get(self):
        self.render('template_stock.html', err_msg="", imgpath="", lists=[])
    ...
    def post(self):
        ...
        if self.request.files:
            ...
            if extension[1:] not in EXTS:
                ...
                self.render('template_stock.html', err_msg=err_msg, imgpath=img_path, lists=[])
        ...
        self.render('template_stock.html', err_msg=err_msg, imgpath=dst_full, lists=lists)
